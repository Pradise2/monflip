...
export const GameBoard: React.FC<GameBoardProps> = ({
  ...
  useEffect(() => {
    const preloadImages = [
      'Background-moncock.svg',
      'Background-choc.webp',
      'Background-monlandak.svg'
    ];
      ...
      >
        <div className="relative w-full h-full" style={{ aspectRatio: '16/9' }}>
          ...
          <button
            ...
            className={`absolute left-[30%] bottom-[5%] w-auto min-w-[120px] min-h-[40px] flex items-center justify-center
          ...
          <button
            ...
            disabled={isFlipping || gameState !== 'playing' || currentRound >= 15}
            className={`absolute right-[30%] bottom-[5%] w-auto min-w-[120px] min-h-[40px] flex items-center justify-center
              bg-black/50 backdrop-blur-sm px-[1.5vw] py-[1vw] rounded-full transition-all
              ${!isFlipping && gameState === 'playing' && currentRound < 15 ? 'opacity-100 cursor-pointer hover:bg-black/60' : 'opacity-50 cursor-not-allowed'}`}
            >
          ...
          >
            ...
            <span className="text-white text-[1.6vw] font-medium whitespace-nowrap">Cash Out</span>
          </button>

          {/* Bet Amount and Action Buttons - Positioned at 12% from right and 15% from bottom */}
          <div className="absolute right-[7%] bottom-[15%] w-auto min-w-[200px]">
            {isIdle ? (
              <div className="flex items-center justify-between gap-[0.5vw] bg-black/50 backdrop-blur-sm px-[1.5vw] py-[0.8vw] rounded-full">
                <span className="text-white text-[1.3vw] font-medium whitespace-nowrap">Bet</span>
                <div className="flex-1 flex items-center justify-center">
                  <input
                    ...
                    className="w-full bg-transparent border-0 text-white text-center focus:ring-0 focus:outline-none text-[1.2vw]"
                    min="0.1"
                    max="5"
                    step="0.1"
                    disabled={isFlipping}
                ...
                <button
                  onClick={onStartGame}
                  className="ml-2 px-[1.5vw] py-[0.4vw] min-w-[60px] bg-green-600 hover:bg-green-700 text-white rounded-full transition-colors text-[0.9vw] whitespace-nowrap"
                  disabled={isFlipping}
                >
                  Start
                </button>
              ...
              <div className="w-full">
                <div className="flex items-center justify-center bg-black/50 backdrop-blur-sm px-[1.5vw] py-[0.8vw] rounded-full">
                  <div className="text-center">
                    <span className="text-white text-[1.2vw] whitespace-nowrap">
          ...
          <div className="absolute top-[2%] right-[2%] bg-black/50 backdrop-blur-sm rounded-lg px-[1.5vw] py-[0.8vw] w-auto min-w-[200px]">
